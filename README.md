...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/FernandaMurched/blogpessoal_spring.git) dentro da pasta do *Workspace* do STS
...
Desenvolvido por [**Fernanda**](https://github.com/FernandaMurched)
