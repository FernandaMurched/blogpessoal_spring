...
@Entity
@Table(name = "tb_postagens") // Cria o comando CREATE TABLE tb_postagens();
public class Postagem {

	@Id // Equivalente ao atributo Primary Key
	@GeneratedValue(strategy = GenerationType.IDENTITY) // Cria o AUTO_INCREMENT
	private Long id;
